...
decoder = [
    ...
    { 'stream' : 163, 'name' : 'frigo_HP_pression' ,'descr' : 'Pression HP frigo', 'byte1': 88, 'weight1': 1, 'byte2': 0, 'weight2': 0, 'divider': 10 }, 
    { 'stream' : 163, 'name' : 'frigo_BP_pression' ,'descr' : 'Pression BP frigo', 'byte1': 92, 'weight1': 1, 'byte2': 0, 'weight2': 0, 'divider': 10 },
